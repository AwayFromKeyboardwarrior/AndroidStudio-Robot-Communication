...
public class CameraAppearing extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cameratest1);
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])
                    ...
                    Snackbar.make(mLayout, "이 앱을 실행하려면 카메라와 외부 저장소 접근 권한이 필요합니다.",
                        ...
                        public void onClick(View view) {
                            ...
                            ActivityCompat.requestPermissions(CameraAppearing.this, REQUIRED_PERMISSIONS,
